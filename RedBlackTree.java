...
public class RedBlackTree<Key extends Comparable<Key>, Value> {
	...
	private int steps = 1;
	private int redLinks;
	
	//to get a value with a given key
	...
	public void countRedLinks(){
		...
		System.out.print("This tree has " + redLinks + " red links");
	}
	...
	//Getter for steps to see how many steps were taken to find a key 
	public int getSteps() {
		return steps;
	}
